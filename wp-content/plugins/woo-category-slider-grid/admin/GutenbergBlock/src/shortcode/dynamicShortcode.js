 ...
 */
 ...
 const DynamicShortcodeInput = ( { attributes : { shortcode }, shortCodeList, shortcodeUpdate } ) => (
     <Fragment>
        {el('div', {className: 'spwcs-gutenberg-shortcode editor-styles-wrapper'},
            el('select', {className: 'spwcs-shortcode-selector', onChange: e => shortcodeUpdate(e), value: escapeAttribute( shortcode ) },
                el('option', {value: escapeAttribute('0')}, escapeHTML( __( '-- Select a shortcode --', 'woo-category-slider-grid' ))),
