...
class Merchant_Product_Bundles extends Merchant_Add_Module {
	...
	public function __construct() {
		...
		$this->ai_examples = array(
			'blurb'   => esc_html__( 'See what AI can do for your product bundles, from creating a new one to adjusting its pricing or how bundled products display.', 'merchant' ),
			'prompts' => array(
				esc_html__( 'Explore the abilities WPVibe gives you access to, then create a Home Office Product Bundle from the Standing Desk, Ergonomic Chair, and Desk Lamp at 15% off the bundle total', 'merchant' ),
				esc_html__( 'Check what abilities you have available through WPVibe, then set up a Starter Fitness Product Bundle priced at a fixed $49 for the whole set instead of a percentage discount', 'merchant' ),
				esc_html__( 'Look at your available WPVibe abilities, then add a Monitor Stand to the Home Office Product Bundle and switch it to a per-item discount', 'merchant' ),
				esc_html__( "See what abilities WPVibe exposes, then change the Home Office Product Bundle's price display to show a subtotal instead of the price per unit", 'merchant' ),
			),
		);
