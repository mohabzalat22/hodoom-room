...
class Merchant_Frequently_Bought_Together extends Merchant_Add_Module {
	...
	public function __construct() {
		...
		$this->ai_examples = array(
			'blurb'   => esc_html__( 'See what AI can do for your Frequently Bought Together bundles, from creating a new one to fine-tuning the discount or copy on an existing offer.', 'merchant' ),
			'prompts' => array(
				esc_html__( 'Explore the abilities WPVibe gives you access to, then create a Frequently Bought Together bundle for the Wireless Earbuds product that also includes the Charging Case and Carrying Pouch, at a 10% discount', 'merchant' ),
				esc_html__( 'Check what abilities you have available through WPVibe, then set up a Frequently Bought Together bundle for the Skincare category with a fixed $5 discount applied to the regular price', 'merchant' ),
				esc_html__( "Look at your available WPVibe abilities, then update the bundle title on the product page for the Wireless Earbuds Frequently Bought Together bundle to 'Complete the Look'", 'merchant' ),
				esc_html__( 'See what abilities WPVibe exposes, then limit the Skincare Frequently Bought Together bundle to exclude any products that are already on sale', 'merchant' ),
			),
		);
