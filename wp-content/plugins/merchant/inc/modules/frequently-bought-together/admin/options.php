...
/**
 * Frequently Bought Together — Option group definitions.
 *
...
return array(
				...
				'offer-details' => array(
					...
					'fields'      => array(
						...
						array(
							...
							'ai_meta' => array(
								'usage_hint' => 'Controls how complementary products are selected: manual or automatic.',
							),
						...
						array(
							...
							'ai_meta' => array(
								'usage_hint' => 'Choose percentage_discount for relative discounts or fixed_discount for absolute amounts. Check if enable_discount is enabled first',
							),
						...
						array(
							...
							'ai_meta' => array(
								...
								'usage_hint'     => 'The discount amount. Percentage (e.g. 10 for 10%% off) or fixed currency amount, depending on discount_type. Check if enable_discount is enabled first',
							),
						...
						array(
							...
							'condition' => array( 'enable_discount', '==', '1' ),
							'ai_meta' => array(
								'usage_hint' => 'Check if enable_discount is enabled first',
							),
						),
	...
	'fields' => array(
		...
		array(
			...
			'default'   => '[merchant_module_' . str_replace( '-', '_', Merchant_Frequently_Bought_Together::MODULE_ID ) . ']',
