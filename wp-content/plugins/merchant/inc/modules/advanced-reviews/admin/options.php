...
/**
 * Advanced Reviews — Option group definitions.
 *
	...
	array(
		...
		'fields' => array(
			...
			array(
				...
				'default' => 0,
				'ai_meta' => array(
					'toggle_for'     => 'discount_generation_method',
					'semantic_group' => 'offer_configuration',
					'usage_hint'     => 'Enable to send a discount coupon email after a customer submits a review. Must be enabled before setting discount_generation_method, discount_type, discount_amount, or discount_expire_after.',
				),
			),
			array(
			...
			array(
				...
				'ai_meta'    => array(
					'semantic_group' => 'offer_configuration',
					'usage_hint'     => 'Controls how discount codes are generated. Use auto for unique per-customer codes, manual for a single reusable code. Requires discount_toggle=true.',
				),
			),
			array(
				'id'         => 'discount_info',
			...
			array(
				...
				'ai_meta'    => array(
					'semantic_group' => 'offer_configuration',
					'usage_hint'     => 'Sets whether the discount is a percentage or a fixed amount. Requires discount_toggle=true and discount_generation_method=auto.',
				),
			),
			array(
				'id'         => 'discount_amount',
				...
				'ai_meta'    => array(
					'semantic_group' => 'offer_configuration',
					'usage_hint'     => 'The numeric discount value. Interpreted as a percentage when discount_type=percent, or as a fixed currency amount when discount_type=fixed_cart. Requires discount_toggle=true and discount_generation_method=auto.',
				),
			),
			array(
				...
				'ai_meta'    => array(
					'semantic_group' => 'offer_configuration',
					'usage_hint'     => 'How many days after issuing before the coupon expires. Use never for no expiry. Requires discount_toggle=true and discount_generation_method=auto.',
				),
			),
			array(
	...
	array(
		...
		'fields' => array(
			...
			array(
				...
				'default'   => '[merchant_module_' . str_replace( '-', '_', Merchant_Advanced_Reviews::MODULE_ID ) . ']',
