...
class Merchant_Scroll_To_Top_Button extends Merchant_Add_Module {
	...
	public function __construct() {
		...
		$this->ai_examples = array(
			'blurb'   => esc_html__( 'See what AI can do for your scroll-to-top button, from repositioning it and restyling it to showing a text label or limiting it to mobile devices.', 'merchant' ),
			'prompts' => array(
				esc_html__( 'Explore the abilities WPVibe gives you access to, then move the scroll-to-top button to the left side of the page', 'merchant' ),
				esc_html__( 'Check what abilities you have available through WPVibe, then switch the scroll-to-top button to the outline style with a dark gray border', 'merchant' ),
				esc_html__( 'Look at your available WPVibe abilities, then show a "Back to top" text label next to the scroll-to-top button\'s icon', 'merchant' ),
				esc_html__( 'See what abilities WPVibe exposes, then only show the scroll-to-top button on mobile devices', 'merchant' ),
			),
		);
