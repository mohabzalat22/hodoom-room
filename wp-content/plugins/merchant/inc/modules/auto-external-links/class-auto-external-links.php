...
class Merchant_Auto_External_Links extends Merchant_Add_Module {
	...
	public function __construct() {
		...
		$this->ai_examples = array(
			'blurb'   => esc_html__( 'See what AI can do for your external links, from opening them all in a new browser tab to turning that behavior back off.', 'merchant' ),
			'prompts' => array(
				esc_html__( 'Explore the abilities WPVibe gives you access to, then turn on Auto External Links so every external link opens in a new browser tab', 'merchant' ),
				esc_html__( 'Check what abilities you have available through WPVibe, then turn Auto External Links back off so external links open in the same tab', 'merchant' ),
			),
		);
