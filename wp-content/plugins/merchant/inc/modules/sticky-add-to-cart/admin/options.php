...
return array(
	...
	'fields' => array(
		...
		array(
			...
			'default' => 1,
			'ai_meta' => array(
				'toggle_for' => 'variation_threshold',
				'usage_hint' => 'Enable this to activate variation_threshold. When on, the sticky bar is hidden until the user selects a variation on variable products with many variants.',
			),
		),
		...
		array(
			...
			'ai_meta' => array(
				'toggled_by' => 'smart_variation_handling',
				'usage_hint' => 'The variation count above which smart_variation_handling kicks in. Only active when smart_variation_handling=true.',
			),
		),
		...
		'fields'    => array(
			...
			array(
				...
				'ai_meta' => array(
					...
					'usage_hint'     => 'Enable before setting excluded_products, excluded_categories, excluded_tags, or excluded_brands. Gates all four exclusion fields.',
				),
			),
			...
			array(
				...
				'ai_meta' => array(
					...
					'usage_hint'        => 'Use ONLY for excluding specific individual products. For broader exclusions, prefer excluded_categories, excluded_tags, or excluded_brands — they are dynamic.',
				),
			),
			...
			array(
				...
				'ai_meta' => array(
					...
					'abstraction_level' => 3,
					'toggled_by'        => 'exclusion',
					'usage_hint'        => 'Use when excluding products by category. Dynamic: future products added to the category are automatically excluded. Requires exclusion=true.',
				),
			),
			...
			array(
				...
				'ai_meta' => array(
					...
					'abstraction_level' => 2,
					'toggled_by'        => 'exclusion',
					'usage_hint'        => 'Use when excluding products by tag. Dynamic: future products added to the tag are automatically excluded. Requires exclusion=true.',
				),
			),
			...
			array(
				...
				'ai_meta' => array(
					...
					'abstraction_level' => 4,
					'toggled_by'        => 'exclusion',
					'usage_hint'        => 'Use when excluding products by brand. Dynamic: future products added to the brand are automatically excluded. Requires exclusion=true.',
				),
			),
		),
	),
