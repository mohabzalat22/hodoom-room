...
class Merchant_Sticky_Add_To_Cart extends Merchant_Add_Module {
	...
	public function __construct() {
		...
		$this->ai_examples = array(
			'blurb'   => esc_html__( 'See what AI can do for your sticky add-to-cart bar, from changing where it sits and what it shows to hiding it on the products and devices you choose.', 'merchant' ),
			'prompts' => array(
				esc_html__( 'Explore the abilities WPVibe gives you access to, then move the sticky add-to-cart bar to the top of the page and have it appear after 300px of scrolling', 'merchant' ),
				esc_html__( 'Check what abilities you have available through WPVibe, then hide the product image and quantity selector on the sticky add-to-cart bar so it shows just the title, price and add-to-cart button', 'merchant' ),
				esc_html__( 'Look at your available WPVibe abilities, then show the sticky add-to-cart bar on mobile and tablet only', 'merchant' ),
				esc_html__( 'See what abilities WPVibe exposes, then stop the sticky add-to-cart bar from showing on any product in the Clearance category', 'merchant' ),
			),
		);
