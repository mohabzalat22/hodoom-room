...
return array(
	...
	'fields' => array(
		...
		array(
			...
			'default'   => 20,
			'ai_meta'   => array(
				'usage_hint' => 'WordPress hook priority for the widget output. Lower number = higher priority (renders first). Adjust when theme or other plugins output to the same hook location.',
			),
		),
		array(
			'id'      => 'hook_order_info',
		...
		array(
			...
			'ai_meta' => array(
				'usage_hint' => 'Controls which page types display the recently-viewed products widget. Select all page types where it should appear.',
			),
		),
	),
),
	...
	'fields' => array(
		...
		array(
			...
			'default'   => '[merchant_module_' . str_replace( '-', '_', Merchant_Recently_Viewed_Products::MODULE_ID ) . ']',
