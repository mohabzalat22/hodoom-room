...
class Merchant_Recently_Viewed_Products extends Merchant_Add_Module {
	...
	public function __construct() {
		...
		$this->ai_examples = array(
			'blurb'   => esc_html__( 'See what AI can do for your recently viewed products, from where they appear and how many show to how the products grid is laid out.', 'merchant' ),
			'prompts' => array(
				esc_html__( 'Explore the abilities WPVibe gives you access to, then show the last 8 recently viewed products in a 4-column grid', 'merchant' ),
				esc_html__( 'Check what abilities you have available through WPVibe, then also display the recently viewed products on the cart and checkout pages', 'merchant' ),
				esc_html__( 'Look at your available WPVibe abilities, then switch the recently viewed products to a slider layout with the navigation arrows always visible', 'merchant' ),
				esc_html__( "See what abilities WPVibe exposes, then change the recently viewed heading to 'Recently Browsed' and show it as an H3", 'merchant' ),
			),
		);
