...
/**
 * Volume Discounts — Option group definitions.
 *
...
return array(
				...
				'offer-details' => array(
					...
					'fields'      => array(
						...
						array(
							...
							'ai_meta' => array(
								'usage_hint' => 'When enabled, quantity thresholds count total cart items rather than per-product. Only applies when rules_to_display=all.',
							),
						),
						array(
							'id'            => 'product_id',
							...
							'ai_meta' => array(
								...
								'semantic_group'    => 'product_targeting',
								'abstraction_level' => 1,
								'usage_hint'        => 'Use when targeting specific individual products by name. Requires rules_to_display=products.',
							),
						),
						array(
							'id'          => 'category_slugs',
						...
						array(
							...
							'condition'   => array( 'rules_to_display', '==', 'categories' ),
							'ai_meta' => array(
								'usage_hint' => 'When enabled, quantity thresholds count all products within the selected categories rather than per-product. Only applies when rules_to_display=categories.',
							),
						),
						array(
						...
						array(
							...
							'ai_meta' => array(
								...
								'usage_hint'     => 'Minimum quantity to trigger this tier discount.',
							),
						),
						...
						array(
							...
							'default' => false,
							'ai_meta' => array(
								'usage_hint' => 'When enabled, coupon codes cannot be stacked on top of this volume discount campaign.',
							),
						),
	...
	'fields' => array(
		...
		array(
			...
			'default'   => '[merchant_module_' . str_replace( '-', '_', Merchant_Volume_Discounts::MODULE_ID ) . ']',
