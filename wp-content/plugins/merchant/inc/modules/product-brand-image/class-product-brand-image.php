...
class Merchant_Product_Brand_Image extends Merchant_Add_Module {
	...
	public function __construct() {
		...
		$this->ai_examples = array(
			'blurb'   => esc_html__( 'See what AI can do for your product brand image, from setting a store-wide image and adjusting its size and spacing to giving a specific product its own.', 'merchant' ),
			'prompts' => array(
				esc_html__( 'Explore the abilities WPVibe gives you access to, then set the store-wide brand image that shows on all my products', 'merchant' ),
				esc_html__( 'Check what abilities you have available through WPVibe, then cap the brand image at 200px wide and 120px tall', 'merchant' ),
				esc_html__( 'Look at your available WPVibe abilities, then add 30px of spacing above the brand image and 10px below', 'merchant' ),
				esc_html__( 'See what abilities WPVibe exposes, then set a different brand image on the Organic Cotton Tee product', 'merchant' ),
			),
		);
