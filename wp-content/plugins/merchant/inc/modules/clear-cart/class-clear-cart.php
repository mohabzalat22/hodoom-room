...
class Merchant_Clear_Cart extends Merchant_Add_Module {
	...
	public function __construct() {
		...
		$this->ai_examples = array(
			'blurb'   => esc_html__( 'See what AI can do for your Clear Cart button, from where it appears in the cart to when it prompts shoppers to empty their cart.', 'merchant' ),
			'prompts' => array(
				esc_html__( 'Explore the abilities WPVibe gives you access to, then turn on Clear Cart and show the button on the cart page after the coupon field', 'merchant' ),
				esc_html__( "Check what abilities you have available through WPVibe, then change the Clear Cart button label to 'Empty My Cart' and update its confirmation message", 'merchant' ),
				esc_html__( 'Look at your available WPVibe abilities, then only show the Clear Cart button once the cart has at least 3 items', 'merchant' ),
				esc_html__( 'See what abilities WPVibe exposes, then prompt shoppers to clear their cart after 12 hours of inactivity', 'merchant' ),
			),
		);
