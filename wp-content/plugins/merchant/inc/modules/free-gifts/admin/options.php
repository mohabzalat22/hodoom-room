...
/**
 * Free Gifts — Option group definitions.
 *
...
return array(
					...
					'fields'      => array(
						...
						array(
							...
							'ai_meta' => array(
								...
								'usage_hint'     => 'Controls which products this campaign applies to. Set this BEFORE setting product_to_display, category_slugs, tag_slugs, or brand_slugs — those fields are conditional on this value.',
							),
						...
						array(
							...
							'ai_meta' => array(
								...
								'semantic_group'    => 'product_targeting',
								'abstraction_level' => 1,
								'usage_hint'        => 'Use when targeting specific individual products by name or SKU. Requires rules_to_apply=products.',
							),
						...
						'amount' => array(
							...
							'ai_meta' => array(
								...
								'usage_hint'     => 'Minimum cart spend to trigger the free gift.',
							),
						...
						array(
							...
							'ai_meta' => array(
								...
								'semantic_group'    => 'offer_rules',
								'abstraction_level' => 1,
								'usage_hint'        => 'The product given as a free gift when the spending threshold is met.',
							),
						...
						array(
							...
							'default' => 1,
							'ai_meta' => array(
								'usage_hint' => 'When enabled, coupon codes cannot be stacked on top of this campaign.',
							),
	...
	'fields' => array(
		array(
			...
			'default' => 'manual',
							'ai_meta' => array(
								'usage_hint' => 'Controls how customers claim the free gift: auto-add or manual.',
							),
		...
		array(
			...
			'default' => 'subtotal',
							'ai_meta' => array(
								'usage_hint' => 'Whether to calculate spending threshold based on subtotal or total (including tax/shipping).',
							),
