...
class Merchant_Product_Navigation_Links extends Merchant_Add_Module {
	...
	public function __construct() {
		...
		$this->ai_examples = array(
			'blurb'   => esc_html__( 'See what AI can do for your product navigation links, from turning them on to controlling how they look and which products they point to.', 'merchant' ),
			'prompts' => array(
				esc_html__( 'Explore the abilities WPVibe gives you access to, then turn on Product Navigation Links so next and previous links appear on single product pages', 'merchant' ),
				esc_html__( 'Check what abilities you have available through WPVibe, then set the navigation mode to Category so the links only move between products in the same category', 'merchant' ),
				esc_html__( "Look at your available WPVibe abilities, then switch the navigation text to show full product titles instead of the generic 'Previous' and 'Next' labels", 'merchant' ),
				esc_html__( 'See what abilities WPVibe exposes, then move the product navigation links to after the product summary and underline the text', 'merchant' ),
			),
		);
