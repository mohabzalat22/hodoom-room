...
class Merchant_Side_Cart extends Merchant_Add_Module {
	...
	public function __construct() {
		...
		$this->ai_examples = array(
			'blurb'   => esc_html__( 'See what AI can do for your side cart, from choosing which pages it slides open on to setting up product upsells inside it.', 'merchant' ),
			'prompts' => array(
				esc_html__( 'Explore the abilities WPVibe gives you access to, then make the side cart slide open from the left and show it after adding a product from the single product page', 'merchant' ),
				esc_html__( 'Check what abilities you have available through WPVibe, then set up a side cart upsell that recommends our Wool Beanie whenever a Winter Jacket is added to the cart', 'merchant' ),
				esc_html__( "Look at your available WPVibe abilities, then change the upsell heading to 'Complete your look' and limit the side cart to 3 upsell suggestions", 'merchant' ),
				esc_html__( 'See what abilities WPVibe exposes, then turn on the side cart\'s floating cart icon and move it to the left side of the screen', 'merchant' ),
			),
		);
