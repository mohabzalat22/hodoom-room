...
/**
 * Side Cart — Option group definitions.
 *
					...
					'fields'      => array(
						array(
							...
							'ai_meta' => array(
								...
								'usage_hint'     => 'Controls which cart products trigger this upsell. Set this BEFORE setting product_ids or category_slugs — those fields are conditional on this value.',
							),
						),
						array(
							'id'            => 'product_ids',
							...
							'ai_meta'       => array(
								...
								'semantic_group'    => 'product_targeting',
								'abstraction_level' => 1,
								'usage_hint'        => 'Use when triggering the upsell for specific individual products in the cart. Requires upsell_based_on=products.',
							),
						),
						array(
							'id'          => 'category_slugs',
							...
							'ai_meta'     => array(
								...
								'semantic_group'    => 'product_targeting',
								'abstraction_level' => 3,
								'usage_hint'        => 'Use when triggering the upsell for products from specific categories in the cart. Dynamic: future products in the category are included. Requires upsell_based_on=categories.',
							),
						),
						array(
							'id'         => 'exclusion_toggle',
							...
							'ai_meta'    => array(
								'toggle_for'     => 'excluded_product_ids',
								'semantic_group' => 'product_exclusion',
								'usage_hint'     => 'Enable this toggle before setting excluded_product_ids or excluded_category_slugs. Only available when upsell_based_on is all or categories.',
							),
						),
						array(
							...
							'ai_meta'       => array(
								...
								'semantic_group'    => 'product_exclusion',
								'abstraction_level' => 1,
								'toggled_by'        => 'exclusion_toggle',
								'usage_hint'        => 'Products in the cart that will NOT show this upsell. Requires exclusion_toggle=true.',
							),
						),
						array(
							...
							'ai_meta'     => array(
								...
								'abstraction_level' => 3,
								'toggled_by'        => 'exclusion_toggle',
								'usage_hint'        => 'Cart products from these categories will NOT trigger this upsell. Dynamic: future products in the category are automatically excluded. Requires exclusion_toggle=true and upsell_based_on=all.',
							),
						),
						array(
							...
							'default' => 'products',
							'ai_meta' => array(
								'usage_hint' => 'Controls whether the recommended upsell products are selected individually or by category. Set this BEFORE setting upsells_product_ids or upsells_category_slugs.',
							),
						),
						array(
							...
							'ai_meta'       => array(
								...
								'reference_type' => 'static',
								'value_format'   => 'product_id',
								'usage_hint'     => 'The specific products to recommend as upsells. Requires custom_upsell_type=products.',
							),
						),
						array(
							...
							'ai_meta'     => array(
								...
								'taxonomy'          => 'product_cat',
								'value_format'      => 'slug',
								'usage_hint'        => 'Recommend products from these categories as upsells. Requires custom_upsell_type=categories.',
							),
						),
					),
				),
