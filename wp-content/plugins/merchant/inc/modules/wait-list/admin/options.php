...
/**
 * Wait List — Option group definitions.
 *
...
return array(
	...
	'fields' => array(
		...
		array(
			...
			'default' => __( 'You have been successfully unsubscribed from our stock waitlist for this product.', 'merchant' ),
			'desc'    => esc_html__( 'The message that will show after clicking on the unsubscribe link.', 'merchant' ),
		),
		array(
			'id'            => 'exclude_products',
			...
			'multiple'      => true,
			'desc'          => esc_html__( 'Select any products that will be excluded from the waitlist.', 'merchant' ),
			'allowed_types' => array( 'simple', 'variable' ),
			'ai_meta'       => array(
				'entity'         => 'product',
				'reference_type' => 'static',
				'value_format'   => 'product_id',
				'usage_hint'     => 'Specific products to exclude from the waitlist globally. Static: only the selected products are excluded. For module-wide exclusion of simple and variable products by ID.',
			),
		),
	),
),
	...
	'fields' => array(
		...
		array(
			...
			'default'   => '[merchant_module_' . str_replace( '-', '_', Merchant_Wait_List::MODULE_ID ) . ']',
