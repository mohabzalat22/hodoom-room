...
class Merchant_Agree_To_Terms_Checkbox extends Merchant_Add_Module {
	...
	public function __construct() {
		...
		$this->ai_examples = array(
			'blurb'   => esc_html__( 'See what AI can do for your agree-to-terms checkbox, from requiring shoppers to accept your terms before checkout to rewording the checkbox and pointing it at your terms page.', 'merchant' ),
			'prompts' => array(
				esc_html__( 'Explore the abilities WPVibe gives you access to, then require customers to agree to my Terms & Conditions before they can place an order', 'merchant' ),
				esc_html__( 'Check what abilities you have available through WPVibe, then change the checkbox to read \'I have read and accept the\' followed by a \'Purchase Agreement\' link', 'merchant' ),
				esc_html__( 'Look at your available WPVibe abilities, then point the terms and conditions link to my Terms of Service page', 'merchant' ),
			),
		);
