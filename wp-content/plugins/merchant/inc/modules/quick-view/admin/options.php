...
return array(
	...
	'fields' => array(
		...
		array(
			...
			'default' => 'text',
			'ai_meta' => array(
				'usage_hint' => 'Controls the quick view button appearance. Set to text, icon, or icon-text. This value gates button_text (text|icon-text) and button_icon (icon|icon-text) fields.',
			),
		),
		...
		array(
			...
			'default'   => 'overlay',
			'ai_meta'   => array(
				'usage_hint' => 'Where the quick view button appears on the product card. Set to overlay to float over the image (enables position-top/left controls and mobile_position). Before/after place it relative to the add-to-cart button.',
			),
		),
		...
		array(
			...
			'condition' => array( 'button_position', '==', 'overlay' ),
			'ai_meta'   => array(
				'toggle_for' => 'button-position-top-mobile',
				'usage_hint' => 'Enable to set a separate overlay position for mobile. Gates button-position-top-mobile and button-position-left-mobile. Only available when button_position=overlay.',
			),
		),
	...
	'fields' => array(
		array(
			'id'      => 'modal_layout',
			'type'    => 'radio',
			'title'   => esc_html__( 'Modal layout', 'merchant' ),
			'options' => array(
				'modal'      => esc_html__( 'Centered modal', 'merchant' ),
				'side-panel' => esc_html__( 'Side panel', 'merchant' ),
			),
			'default' => 'modal',
		),
		...
		array(
			...
			'type'    => 'switcher',
			'title'   => esc_html__( 'Show next/previous navigation arrows', 'merchant' ),
			'default' => 0,
		),
		...
		array(
			'id'      => 'sync_url_hash',
			'type'    => 'switcher',
			'title'   => esc_html__( 'Update browser URL when quick view opens', 'merchant' ),
			'default' => 0,
		),
		...
		array(
			...
			'desc'       => esc_html__( 'Default: 1000 pixels', 'merchant' ),
			'min'        => 1,
			'max'        => 2000,
			'step'       => 1,
			'default'    => 1000,
		...
		array(
			'id'         => 'side_panel_width',
			'type'       => 'range',
			'title'      => esc_html__( 'Side panel width', 'merchant' ),
			'desc'       => esc_html__( 'Default: 420 pixels', 'merchant' ),
			'min'        => 280,
			'max'        => 800,
			'step'       => 1,
			'default'    => 420,
		...
		array(
			...
			'default' => 1,
			'ai_meta' => array(
				'toggle_for' => 'suggested_products_module',
				'usage_hint' => 'Enable to display upsell/cross-sell products inside the quick view modal. Gates suggested_products_module and suggested_products_placement fields. Requires Merchant Pro.',
			),
		),
		array(
			...
			'ai_meta'    => array(
				'toggled_by' => 'show_suggested_products',
				'usage_hint' => 'Which Merchant module provides the suggested products shown inside quick view. Requires show_suggested_products=true and the chosen module to be active.',
			),
		),
		array(
	...
	array(
	'module' => Merchant_Quick_View::MODULE_ID,
	...
	'fields' => array(
		...
		array(
			...
			'default'   => '[merchant_module_' . str_replace( '-', '_', Merchant_Quick_View::MODULE_ID ) . ']',
