...
class Merchant_Free_Shipping_Progress_Bar extends Merchant_Add_Module {
	...
	public function __construct() {
		...
		$this->ai_examples = array(
			'blurb'   => esc_html__( 'See what AI can do for your free shipping bar, from rewriting the messages shoppers see to changing where the bar appears and how it looks.', 'merchant' ),
			'prompts' => array(
				esc_html__( "Explore the abilities WPVibe gives you access to, then reword the free shipping bar's in-progress message to 'Only {amount_left} left to unlock free shipping!'", 'merchant' ),
				esc_html__( 'Check what abilities you have available through WPVibe, then move the free shipping bar to the top of the page and set it to stay sticky as shoppers scroll', 'merchant' ),
				esc_html__( 'Look at your available WPVibe abilities, then apply the Ocean Breeze template to the free shipping bar and bump its font size up to 20px', 'merchant' ),
				esc_html__( 'See what abilities WPVibe exposes, then show the free shipping bar only to the Wholesale Customer role', 'merchant' ),
			),
		);
