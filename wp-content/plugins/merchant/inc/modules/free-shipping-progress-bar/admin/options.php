...
return array(
	...
	'fields' => array(
		...
		array(
			...
			'ai_meta' => array(
				...
				'usage_hint'     => 'Controls which users see this free shipping bar. Set this BEFORE setting user_condition_users or user_condition_roles.',
			),
		),
		...
		array(
			...
			'ai_meta'    => array(
				...
				'semantic_group'  => 'user_targeting',
				'abstraction_level' => 2,
				'usage_hint'      => 'Roles that see the free shipping bar. Only used when user_condition is roles.',
			),
		),
		...
		array(
			...
			'ai_meta'    => array(
				...
				'semantic_group'  => 'user_targeting',
				'abstraction_level' => 1,
				'usage_hint'      => 'Specific users that see the free shipping bar. Only used when user_condition is users.',
			),
		),
		...
		array(
			...
			'ai_meta'    => array(
				...
				'usage_hint'      => 'Roles excluded from seeing the free shipping bar. Requires user_exclusion_enabled.',
			),
		),
		...
		array(
			...
			'ai_meta'    => array(
				...
				'abstraction_level' => 1,
				'toggled_by'      => 'user_exclusion_enabled',
				'usage_hint'      => 'Specific users excluded from seeing the free shipping bar. Requires user_exclusion_enabled.',
			),
		),
	),
),
	...
	'fields' => array(
		...
		array(
			...
			'default'    => '[merchant_module_' . str_replace( '-', '_', Merchant_Free_Shipping_Progress_Bar::MODULE_ID ) . '_single_product_page]',
			'conditions' => array(
				'relation' => 'AND',
				'terms'    => array(
					array(
		...
		array(
			...
			'type'       => 'text_readonly',
			'title'      => esc_html__( 'Shortcode text', 'merchant' ),
			'default'    => '[merchant_module_' . str_replace( '-', '_', Merchant_Free_Shipping_Progress_Bar::MODULE_ID ) . '_cart_page]',
			'conditions' => array(
				'relation' => 'AND',
				'terms'    => array(
					array(
		...
		array(
			...
			'type'       => 'text_readonly',
			'title'      => esc_html__( 'Shortcode text', 'merchant' ),
			'default'    => '[merchant_module_' . str_replace( '-', '_', Merchant_Free_Shipping_Progress_Bar::MODULE_ID ) . '_checkout_page]',
			'conditions' => array(
				'relation' => 'AND',
				'terms'    => array(
					array(
