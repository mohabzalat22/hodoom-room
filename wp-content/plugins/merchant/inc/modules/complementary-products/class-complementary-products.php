...
class Merchant_Complementary_Products extends Merchant_Add_Module {
	...
	public function __construct() {
		...
		$this->ai_examples = array(
			'blurb'   => esc_html__( 'See what AI can do for your complementary product offers, from creating a new one to adjusting its discount or where it appears.', 'merchant' ),
			'prompts' => array(
				esc_html__( 'Explore the abilities WPVibe gives you access to, then create a complementary offer that suggests a Yoga Block and Resistance Band alongside the Yoga Mat, at 10% off the bundle', 'merchant' ),
				esc_html__( 'Check what abilities you have available through WPVibe, then set up a complementary offer for the Camping category that adds a Headlamp and Water Filter, with the cheapest item free', 'merchant' ),
				esc_html__( "Look at your available WPVibe abilities, then change the offer title on the Yoga Mat complementary offer to 'Complete Your Home Studio' and move it to show after the product summary", 'merchant' ),
				esc_html__( 'See what abilities WPVibe exposes, then run a complementary offer across all products but exclude anything in the Clearance category', 'merchant' ),
			),
		);
