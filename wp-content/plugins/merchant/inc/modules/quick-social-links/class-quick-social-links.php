...
class Merchant_Quick_Social_Links extends Merchant_Add_Module {
	...
	public function __construct() {
		...
		$this->ai_examples = array(
			'blurb'   => esc_html__( 'See what AI can do for your quick social links, from adding a new platform icon to restyling the bar and choosing where it appears.', 'merchant' ),
			'prompts' => array(
				esc_html__( 'Explore the abilities WPVibe gives you access to, then add our Instagram link to the quick social links', 'merchant' ),
				esc_html__( 'Check what abilities you have available through WPVibe, then move the quick social links to the right side of the screen and show them on mobile and tablet only', 'merchant' ),
				esc_html__( 'Look at your available WPVibe abilities, then set the quick social links icon color to white on a dark background and increase the corner rounding', 'merchant' ),
				esc_html__( 'See what abilities WPVibe exposes, then only show the social links on single product pages and hide them on the cart and checkout', 'merchant' ),
			),
		);
