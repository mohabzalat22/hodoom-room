...
class Merchant_Product_Swatches extends Merchant_Add_Module {
	...
	public function __construct() {
		...
		$this->ai_examples = array(
			'blurb'   => esc_html__( 'See what AI can do for your variation swatches, from styling how they display across your shop to setting the color or image for a specific attribute term.', 'merchant' ),
			'prompts' => array(
				esc_html__( 'Explore the abilities WPVibe gives you access to, then set the color swatch for the Red term of the Color attribute to #C0392B', 'merchant' ),
				esc_html__( 'Check what abilities you have available through WPVibe, then give the Blue term of the Color attribute a gradient swatch blending #2980B9 into #6DD5FA', 'merchant' ),
				esc_html__( 'Look at your available WPVibe abilities, then turn on the tooltip so each swatch shows its name when shoppers hover over it', 'merchant' ),
				esc_html__( 'See what abilities WPVibe exposes, then make the color swatches circular and increase their size to 40px', 'merchant' ),
			),
		);
