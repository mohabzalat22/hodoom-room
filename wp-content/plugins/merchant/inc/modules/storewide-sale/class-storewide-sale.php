...
class Merchant_Storewide_Sale extends Merchant_Add_Module {
	...
	public function __construct() {
		...
		$this->ai_examples = array(
			'blurb'   => esc_html__( 'See what AI can do for your storewide sale campaigns, from launching a discount across your whole store to scoping one to a specific category or set of products.', 'merchant' ),
			'prompts' => array(
				esc_html__( 'Explore the abilities WPVibe gives you access to, then create a Summer Clearance storewide sale taking 20% off all products through the end of the month', 'merchant' ),
				esc_html__( 'Check what abilities you have available through WPVibe, then set up a fixed $15 off storewide sale for the Outdoor Furniture category instead of a percentage', 'merchant' ),
				esc_html__( 'Look at your available WPVibe abilities, then create a storewide sale that takes 10% off the sale price of just the Trail Runner Sneakers and Hiking Boots', 'merchant' ),
				esc_html__( 'See what abilities WPVibe exposes, then update the Summer Clearance storewide sale to exclude any products that are already on sale', 'merchant' ),
			),
		);
