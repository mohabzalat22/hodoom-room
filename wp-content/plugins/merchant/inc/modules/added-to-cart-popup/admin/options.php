...
/**
 * Added To Cart Popup — Option group definitions.
 *
	...
	'fields' => array(
		...
		array(
			...
			'ai_meta' => array(
				...
				'usage_hint' => 'Enable to show a product recommendations section in the popup. Gates suggested_products_module. Recommendation source is controlled by suggested_products_module.',
			),
		),
		array(
			...
			'ai_meta' => array(
				...
				'usage_hint' => 'Choose the source of product recommendations shown in the popup. Requires show_suggested_products=true. Use related_products for WooCommerce defaults or recently_viewed_products for browsing-based recommendations.',
			),
		),
		array(
		...
		array(
			...
			'default' => false,
			'ai_meta' => array(
				'toggle_for'     => 'exclusion_type',
				'semantic_group' => 'product_exclusion',
				'usage_hint'     => 'Enable before setting exclusion_type, exclude_specific_products, or exclude_specific_categories. Gates the entire popup exclusion flow.',
			),
		),
		array(
			'id'         => 'exclusion_type',
			...
			'ai_meta' => array(
				'semantic_group' => 'product_exclusion',
				'toggled_by'     => 'exclusion_list',
				'usage_hint'     => 'Controls which exclusion field is active. Set this BEFORE setting exclude_specific_products or exclude_specific_categories — those fields are conditional on this value.',
			),
		),
		array(
			...
			'ai_meta' => array(
				...
				'abstraction_level' => 1,
				'toggled_by'        => 'exclusion_list',
				'usage_hint'        => 'Use ONLY for excluding the popup on specific individual products. Requires exclusion_list=true and exclusion_type=specific_products. Prefer exclude_specific_categories for category-level intent.',
			),
		),
		array(
			...
			'ai_meta' => array(
				...
				'abstraction_level' => 3,
				'toggled_by'        => 'exclusion_list',
				'usage_hint'        => 'Use when excluding the popup for all products in a category. Dynamic: future products added to the category are automatically excluded. Requires exclusion_list=true and exclusion_type=specific_categories.',
			),
		),
		array(
			'id'      => 'show_pages',
