...
class Merchant_Added_To_Cart_Popup extends Merchant_Add_Module {
	...
	public function __construct() {
		...
		$this->ai_examples = array(
			'blurb'   => esc_html__( 'See what AI can do for your added-to-cart popup, from choosing what shows inside it to controlling where it appears.', 'merchant' ),
			'prompts' => array(
				esc_html__( 'Explore the abilities WPVibe gives you access to, then turn on suggested products in the added-to-cart popup, set their source to Recently Viewed Products, and show a short product description next to the thumbnail', 'merchant' ),
				esc_html__( "Check what abilities you have available through WPVibe, then change the added-to-cart popup's message to 'Great choice, it's in your cart!' and rename the continue shopping button to 'Keep Browsing'", 'merchant' ),
				esc_html__( 'Look at your available WPVibe abilities, then show the added-to-cart popup only on single product pages and only on desktop', 'merchant' ),
				esc_html__( 'See what abilities WPVibe exposes, then stop the added-to-cart popup from appearing for any product in the Gift Cards category', 'merchant' ),
			),
		);
