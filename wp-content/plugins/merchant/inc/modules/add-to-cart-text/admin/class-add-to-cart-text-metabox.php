...
if ( class_exists( 'Merchant_Metabox' ) ) {
	class Merchant_Add_To_Cart_Text_Metabox extends Merchant_Metabox {
		...
		/**
		 * Pure-data field definitions for the add-to-cart-text product metabox.
		 *
		 * @return array<string, array<string, mixed>>
		 */
		public static function get_field_definitions() {
			return array(
				'_merchant_add_to_cart_text_single_label' => array(
				...
				'_merchant_add_to_cart_text_shop_label'   => array(
					'section'   => Merchant_Add_To_Cart_Text::MODULE_ID,
					'type'      => 'text',
