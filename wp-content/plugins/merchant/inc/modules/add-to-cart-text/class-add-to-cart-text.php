...
class Merchant_Add_To_Cart_Text extends Merchant_Add_Module {
	...
	public function __construct() {
		...
		$this->ai_examples = array(
			'blurb'   => esc_html__( "See what AI can do for your 'Add to Cart' button text, from relabeling it by product type and stock status to overriding it on individual products.", 'merchant' ),
			'prompts' => array(
				esc_html__( "Explore the abilities WPVibe gives you access to, then change the 'Add to Cart' button on simple products to 'Buy Now' across the shop", 'merchant' ),
				esc_html__( "Check what abilities you have available through WPVibe, then change the 'Add to Cart' button on variable products to say 'Choose Options' on the single product page", 'merchant' ),
				esc_html__( "Look at your available WPVibe abilities, then show 'Sold Out' on the button for out-of-stock products", 'merchant' ),
				esc_html__( "See what abilities WPVibe exposes, then override the 'Add to Cart' text on the Vintage Leather Wallet to 'Grab Yours'", 'merchant' ),
			),
		);
