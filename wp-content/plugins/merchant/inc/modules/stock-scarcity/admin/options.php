...
/**
 * Stock Scarcity — Option group definitions.
 *
...
return array(
	...
	'fields' => array(
		...
		array(
			...
			'default' => 50,
			'ai_meta' => array(
				'usage_hint' => 'Stock quantity threshold (integer) below which the scarcity urgency box is displayed. Applies per variant for variable products.',
			),
		),
		array(
			'id'      => 'display-pages',
			...
			'ai_meta' => array(
				'usage_hint' => 'Controls which page types display the stock scarcity urgency box. Select product for single product pages, archive for shop/category listing pages.',
			),
		),
	...
	'fields' => array(
		...
		array(
			...
			'type'    => 'text',
			'title'   => esc_html__('Text when inventory is low (when only 1 item left in stock)', 'merchant'),
		...
		array(
			...
			'type'    => 'text',
			'title'   => esc_html__('Text when inventory is low (when more than 1 item is left in stock)', 'merchant'),
		...
		array(
			...
			'type'    => 'text',
			'title'   => esc_html__('Text when inventory is low (variable - used for product variation)', 'merchant'),
	...
	'fields' => array(
		...
		array(
			...
			'default'   => '[merchant_module_' . str_replace('-', '_', Merchant_Stock_Scarcity::MODULE_ID) . ']',
