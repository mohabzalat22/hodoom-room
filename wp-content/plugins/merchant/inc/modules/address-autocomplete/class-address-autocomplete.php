...
class Merchant_Address_Autocomplete extends Merchant_Add_Module {
	...
	public function __construct() {
		...
		$this->ai_examples = array(
			'blurb'   => esc_html__( 'See what AI can do for your checkout address autocomplete, from switching it on to connecting your Google Places API key.', 'merchant' ),
			'prompts' => array(
				esc_html__( 'Explore the abilities WPVibe gives you access to, then turn on Google address autocomplete at checkout', 'merchant' ),
				esc_html__( 'Check what abilities you have available through WPVibe, then add my Google Places API key so the address autocomplete starts suggesting addresses', 'merchant' ),
				esc_html__( "Look at your available WPVibe abilities, then set the address autocomplete's optional API URL parameters to region=us and language=en", 'merchant' ),
			),
		);
