	...
	'fields' => array(
		...
		array(
			...
			'ai_meta' => array(
				...
				'usage_hint'     => 'Enable this toggle before setting excluded_products. When on, notifications will not be shown for the selected products.',
			),
		),
		array(
			...
			'ai_meta' => array(
				...
				'semantic_group'    => 'product_exclusion',
				'abstraction_level' => 1,
				'toggled_by'        => 'product_exclusion',
				'usage_hint'        => 'Products selected here will never trigger a sales notification. Requires product_exclusion=true. Static: only the listed products are excluded.',
			),
		),
	),
),
