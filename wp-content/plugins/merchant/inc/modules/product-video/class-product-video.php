...
class Merchant_Product_Video extends Merchant_Add_Module {
	...
	public function __construct() {
		...
		$this->ai_examples = array(
			'blurb'   => esc_html__( 'See what AI can do for your product videos, from adding one to a specific product to adjusting autoplay and aspect ratio across your store.', 'merchant' ),
			'prompts' => array(
				esc_html__( "Explore the abilities WPVibe gives you access to, then set the Aurora Yoga Mat's product video to a YouTube demo URL", 'merchant' ),
				esc_html__( 'Check what abilities you have available through WPVibe, then turn on autoplay so product videos start playing automatically', 'merchant' ),
				esc_html__( 'Look at your available WPVibe abilities, then change the product video aspect ratio to 9:16 for vertical clips', 'merchant' ),
				esc_html__( 'See what abilities WPVibe exposes, then enable the shortcode option so I can place the product video with a shortcode in my page builder', 'merchant' ),
			),
		);
