...
<?php if ( ! empty( $merchant_module_info ) ) : ?>
                        ...
                        <div class="merchant-module-page-actions">
                            ...
                            <div class="merchant-module-page-actions-inner">
                                ...
                                <div class="merchant-module-page-actions-links">
									...
									<?php if ( ! empty( $merchant_module_info['ai_examples']['blurb'] ) ) : ?>
										<button
											type="button"
											class="merchant-module-page-link merchant-module-page-link-ai merchant-ai-badge"
											data-ai-title="<?php echo esc_attr( $merchant_module_info['title'] ); ?>"
											data-ai-blurb="<?php echo esc_attr( $merchant_module_info['ai_examples']['blurb'] ); ?>"
											data-ai-prompts="<?php echo esc_attr( wp_json_encode( $merchant_module_info['ai_examples']['prompts'] ?? array() ) ); ?>"
										>
											<svg width="14" height="14" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
												<path d="M8 1L10.5 5.5L15 8L10.5 10.5L8 15L5.5 10.5L1 8L5.5 5.5Z" fill="currentColor"/>
											</svg>
											<span><?php esc_html_e( 'Try with AI', 'merchant' ); ?></span>
										</button>
									<?php endif; ?>
	...
	<?php require MERCHANT_DIR . 'admin/components/ai-prompts-modal.php'; ?>
