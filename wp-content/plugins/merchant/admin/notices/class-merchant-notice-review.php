		...
		<div class="merchant-notice notice" style="position:relative;">
			<p>
				...
				printf(
					...
					esc_html__(
						'Hi %1$s, we hope you\'re enjoying using Merchant. We have a small request that would mean a lot to us. Could you please leave a review for Merchant on WordPress.org? Your support will not only motivate us but also help other users feel confident in choosing our plugin. Thank you!', 
						'merchant'
					),
